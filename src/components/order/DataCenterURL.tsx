    ...
    <>
      ...
      <section className="max-w-5xl mx-auto pb-40 pt-12">
        ...
        <div className="space-x-4 mt-4">
          <button className="text-blue-700  hover:bg-blue-700 border border-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            <a href="/order/user-profile-3">previous</a>
          </button>
          <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            <a href="/order/checkout-5">Choose Payment Method</a>
          </button>
        </div>
      </section>
    </>
